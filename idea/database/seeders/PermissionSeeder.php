...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            //*** Payment Modules ***//
            ['name' => 'payments-view', 'group' => 'Payment', 'title' => 'View'],
            ['name' => 'payments-create', 'group' => 'Payment', 'title' => 'Admission'],
            ['name' => 'payments-edit', 'group' => 'Payment', 'title' => 'Action'],
            ['name' => 'payments-delete', 'group' => 'Payment', 'title' => 'Delete'],
            //*** Payment Modules ***//
            ...
            //*** Payment Modules ***//
            ['name' => 'payment-view', 'group' => 'Payment', 'title' => 'View'],
            ['name' => 'payment-create', 'group' => 'Payment', 'title' => 'Admission'],
            ['name' => 'payment-edit', 'group' => 'Payment', 'title' => 'Action'],
            ['name' => 'payment-delete', 'group' => 'Payment', 'title' => 'Delete'],
            //*** Payment Modules ***//
        ];
