    ...
    <script src="{{ asset('web\js\common\sweet-alert\sweetalert.min.js') }}"></script>
    ...
    <script src="{{asset('web\js\common\common.js?'.\Illuminate\Support\Str::random(5))}}"></script>
    <script src="{{asset('web\js\common\jquery.validate.min.js')}}"></script>
    <script src="{{asset('web\js\student\pay.js?'.\Illuminate\Support\Str::random(5))}}"></script>
    <script src="{{asset('web\js\common\jquery.blockUI.js')}}"></script>
