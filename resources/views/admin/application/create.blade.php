                    ...
                    @csrf
                        ...
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="invalid-feedback">
                                  {{ __('required_field') }} {{ __('field_member_type') }}
                                </div>
                            </div>
                                <div class="form-group col-md-6">
                                    <label for="gender">{{ __('field_member_type') }} <span>*</span></label>
                                    <select class="form-control" name="gender" id="gender" required>
                                        <option value="">{{ __('select') }}</option>
                                        <option value="1" @if( old('member_type') == 1 ) selected @endif>{{ __('member_type_distance') }}</option>
                                        <option value="2" @if( old('member_type') == 2 ) selected @endif>{{ __('member_type_regular') }}</option>
                                    </select>
