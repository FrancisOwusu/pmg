...
{{--              <form class="needs-validation" novalidate action="{{ route($route.'.pay') }}" method="post" enctype="multipart/form-data">--}}
              <form class="needs-validation" novalidate action="{{ route("student_fees.pay") }}" method="post" enctype="multipart/form-data">
                @csrf
...
{{--                     {{$row}}--}}
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" style="display:none" class="form-control" name="student_id"  value="{{ $row->studentEnroll->student->student_id ?? ''  }}" required readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control autonumber" name="amount_paid" id="net_amount" value="{{ round($net_amount, 2) }}"  required readonly>
